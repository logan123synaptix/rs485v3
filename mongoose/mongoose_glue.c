...
// Do not edit! See https://mongoose.ws/docs/guides/web-ui-builder/#custom-api-handlers
static uint64_t s_action_timeout_console_send;  // Time when console_send ends
bool glue_check_console_send(void) {
  return s_action_timeout_console_send > mg_now(); // Return true if console_send is in progress
}
void glue_start_console_send(struct mg_str params) {
  MG_DEBUG(("Passed parameters: [%.*s]", params.len, params.buf));
  s_action_timeout_console_send = mg_now() + 1000; // Start console_send, finish after 1 second
}


// Do not edit! See https://mongoose.ws/docs/guides/web-ui-builder/#custom-api-handlers
static struct state s_state = {42, 27, 67, 10, "1.0.0", true, false, 83, "no checks done yet"};
...
// Do not edit! See https://mongoose.ws/docs/guides/web-ui-builder/#custom-api-handlers
static struct settings s_settings = {"edit & save me", 2, 123.12345, 17, true, 300, "http://mongoose.ws/downloads/metadata.json"};
